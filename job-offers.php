...
<title>Jobs Offer | HR Platform for Efficient Employers.</title>
        ...
        <div class="row">
                    ...
                    <div class="col-3">
                     ...
                     <ul id="nav_list">
                        ...
                        <div class="sidebar-list">
                        <i class="fa fa-briefcase"></i>&nbsp;&nbsp; <b>Job Offers</b>     
                        </div></a> 
                        </li>
        ...
        <div class="col-md-9 col-12" id="credentials_banner">
            ...
            <tbody>
              <tr>
                ...
                <td>Nov 20, 2021</td>
                <td>Nov 1, 2021</td>
                <td><button style="background-color:#00A0E3;">Apply</button></td>
              </tr>
              <tr>
